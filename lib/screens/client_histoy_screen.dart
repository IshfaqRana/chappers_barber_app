...
class ClientHistory extends StatefulWidget{
  ...
  @override
  State<ClientHistory> createState() => _CHistory();
}

class _CHistory extends State<ClientHistory>{
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(
                                  height: height*0.06,
                                  width: width,
                                  child: const Center(child: Text('Client History',style: TextStyle(fontSize: 20,color: Colors.black26,fontWeight: FontWeight.bold)))
                              ),
